...
process.akVs1PFJetAnalyzer.jetPtMin = cms.untracked.double(1)
process.akVs1CaloJetAnalyzer.jetPtMin = cms.untracked.double(1)

process.akVs2PFJetAnalyzer.jetPtMin = cms.untracked.double(1)
process.akVs2CaloJetAnalyzer.jetPtMin = cms.untracked.double(1)

process.akVs3PFJetAnalyzer.jetPtMin = cms.untracked.double(1)
process.akVs3CaloJetAnalyzer.jetPtMin = cms.untracked.double(1)

process.akVs4PFJetAnalyzer.jetPtMin = cms.untracked.double(1)
process.akVs4CaloJetAnalyzer.jetPtMin = cms.untracked.double(1)

process.akVs5PFJetAnalyzer.jetPtMin = cms.untracked.double(1)
process.akVs5CaloJetAnalyzer.jetPtMin = cms.untracked.double(1)

process.akVs6PFJetAnalyzer.jetPtMin = cms.untracked.double(1)
process.akVs6CaloJetAnalyzer.jetPtMin = cms.untracked.double(1)
